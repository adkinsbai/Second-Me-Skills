...
export default function PrivacyPage() {
  return (
    <main className="app-container max-w-2xl space-y-4 py-10 text-sm leading-relaxed text-gray-600">
      <h1 className="luxury-title text-xl font-semibold">隐私与数据说明（摘要）</h1>
      <p>
        丘比会收集你在注册、个人资料、问卷与真人聊天中主动提供的信息，用于：生成匹配推荐、书写故事化匹配开场、改进产品体验。
      </p>
      <p>
      ...
      <Link href="/onboarding" className="inline-block text-[var(--brand-text)] underline underline-offset-2">
        返回引导页
      </Link>
    </main>
  );
